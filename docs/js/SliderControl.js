L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        this.options.sliderFullId = "#leaflet-slider" + this.options.sliderId;
        this.options.sliderTimeStampId = "#slider-timestamp" + this.options.sliderId;
    ...
    onRemove: function (map) {
        ...
        $(this.options.sliderFullId).remove();
                ...
                if(!!_options.markers[ui.value]) {
                    ...
                    if(_options.markers[ui.value].feature !== undefined) {
                        if(_options.markers[ui.value].feature.properties[_options.timeAttribute]){
                            if(_options.markers[ui.value]) $(_options.sliderTimeStampId).html(
